...
import { fetchNotifications, markNotificationsAsRead } from '@/app/actions';
...
export function AppHeader() {
  ...
  return (
    <>
    <header className="flex items-center justify-between border-b bg-card p-2 md:p-4 shadow-sm sticky top-0 z-40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="flex items-center gap-1 md:gap-3">
        <SidebarTrigger className="md:hidden" />
        <div className="flex items-center gap-2">
            <School className="h-8 w-8 text-primary" />
            <h1 className="text-xl font-bold font-headline text-primary hidden sm:block">AcademiCS</h1>
        </div>
      </div>
