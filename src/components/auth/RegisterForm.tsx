...
import { Loader2, UserPlus, BookOpenCheck, GraduationCap } from 'lucide-react';
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
           ...
           <div className="space-y-2">
                ...
                <RadioGroup defaultValue="student" value={role} onValueChange={(value: string) => setRole(value as UserRole)} className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
                    <Label htmlFor="r-student" className="flex items-center justify-center sm:justify-start gap-2 font-normal cursor-pointer rounded-md border p-3 has-[:checked]:border-primary">
                        <RadioGroupItem value="student" id="r-student" className="sr-only" />
                        <GraduationCap/>Estudiante
                    </Label>
                    <Label htmlFor="r-teacher" className="flex items-center justify-center sm:justify-start gap-2 font-normal cursor-pointer rounded-md border p-3 has-[:checked]:border-primary">
