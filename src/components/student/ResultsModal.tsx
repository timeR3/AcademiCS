      ...
      <Dialog open={true} onOpenChange={(isOpen) => { if (!isOpen) onNext(); }}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader className="text-center items-center">
              {isCourseCompleted ? (
                <Trophy className="h-20 w-20 text-accent-foreground mb-4" />
              ) : passed ? (
          ...
          {!passed && incorrectAnswers && incorrectAnswers.length > 0 && (
              <>
                  ...
                  <div className='my-4'>
                      ...
                      <ScrollArea className='h-40 w-full rounded-xl border bg-secondary/50 p-4'>
                              ...
                              {incorrectAnswers.map((item, index) => (
                                  <div key={index} className='text-sm'>
                                      ...
                                      <div className='mt-1 flex items-start gap-2 text-destructive'>
                                       ...
                                       <div className='mt-1 flex items-start gap-2 text-secondary'>
