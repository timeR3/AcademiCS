...
export function CategoriesView() {
    ...
    const handleStatusChange = async (category: CourseCategory, newStatus: boolean) => {
        ...
        setIsSaving(true);
        try {
            await updateCategory({ id: category.id, status });
    ...
    const handleUpdateName = async () => {
        ...
        setIsSaving(true);
        try {
            await updateCategory({ id: editingCategory.id, name: editingName });
                                        ...
                                        <TableRow key={category.id}>
                                            ...
                                            <TableCell className="text-right space-x-2">
                                                 <Switch
                                                    ...
                                                    disabled={isSaving || (category.courseCount && category.courseCount > 0 && category.status === 'active')}
