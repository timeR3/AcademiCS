...
import { Pencil, Trash2, Search, Tag, Users, Star } from 'lucide-react';
...
export function CoursesView({ onEditCourse }: CoursesViewProps) {
                                ...
                                <TableBody>
                                    {loading ? (
                                        ...
                                        filteredCourses.map(course => {
                                            ...
                                            return (
                                                <TableRow key={course.id} onClick={() => setSelectedCourse(course)} className="cursor-pointer">
            ...
            <Dialog open={!!selectedCourse} onOpenChange={(isOpen) => !isOpen && handleCloseDialog()}>
                <DialogContent className="sm:max-w-4xl">
                                                ...
                                                <TableRow key={student.id}>
                                                    ...
                                                    <TableCell className="text-right font-medium">
                                                        {student.finalScore !== undefined ? (
                                                            <span className="flex items-center justify-end gap-1 text-green-600"><Star className="h-4 w-4"/> {student.finalScore.toFixed(1)}%</span>
                                                        ) : (
                    ...
                    <DialogFooter>
                        ...
                        <Button onClick={handleEditClick}><Pencil className="mr-2"/> Editar Curso</Button>
                    </DialogFooter>
                </DialogContent>
            </Dialog>
        </>
