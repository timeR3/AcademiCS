'use server';
import type { CreateSyllabusOutput as CreateSyllabusOutputFlow, CreateSyllabusInput as CreateSyllabusInputFlow } from '@/ai/flows/create-syllabus';
import type { GenerateQuestionnaireOutput } from '@/ai/flows/generate-questionnaire';

export type Question = GenerateQuestionnaireOutput['questionnaire'][0] & { id?: string };
export type SyllabusSection = CreateSyllabusOutputFlow['learningPath'][0]['syllabus'][0] & { id?: string };

export type CreateSyllabusInput = CreateSyllabusInputFlow;

export type CreateSyllabusOutput = CreateSyllabusOutputFlow;
...
// Ensure createSyllabus doesn't return fullTranscribedText
export const CreateSyllabusClientOutputSchema = CreateSyllabusOutputSchema.omit({ structuredContent: true });
